...
### ✅ Funcionalidade Extra — Sorteio de Responsáveis
Ao registrar uma tarefa, o sistema sorteia automaticamente um funcionário responsável de forma rotativa, garantindo distribuição justa das tarefas entre a equipe. Cada funcionário só é sorteado novamente após todos terem sido escolhidos pelo menos uma vez.
...
> ⚠️ Animais com estado de saúde `"mal"` não aparecem nos resultados do sistema do usuário.
...
- O campo estado de saúde `"mal"` oculta o animal do sistema de adoção
